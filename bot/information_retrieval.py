...
def create_player_info_card(data):
    ...
    past_10k_trophies = data.get('progress', {}).get('seasonal-trophy-road-202511', {}).get('trophies', 0) # update every season
    past_10k_best_trophies = data.get('progress', {}).get('seasonal-trophy-road-202511', {}).get('bestTrophies', 0) # update every season
    ...
    seasonal_arena = data.get('progress', {}).get('seasonal-trophy-road-202511', {}).get('arena', {}).get('name', 'N/A') # update every season
